...
const SignupForm = () => {
  ...
  return (
    <React.Fragment>
              ...
              <div className="FormField">
                <div className="FormField__CheckboxLabel">
                  ...
                  <div className="confirm-checkbox">
                    I agree all statements in <a onClick={toggle} className="FormField__TermsLink" style={toaStyle}>terms of service</a>
                  </div>
                </div>
              </div>
      ...
      <div>
        <Modal isOpen={modal} toggle={toggle} className="styleModal">
          ...
          <ModalBody>
            ...
            <ul>
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NIT Company, Zmaja od Bosne 9.</li>
              <li><strong>Country</strong> refers to: Bosnia and Herzegovina</li>
              ...
              <li><strong>Website</strong> refers to hopZone, accessible from http://www.hopzone.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
            </ul>
            ...
            <ul>
              <li>By visiting this page on our website: http://www.mysite.com/contact</li>
            </ul>
          </ModalBody>
          <ModalFooter>
            <Button style={{
              backgroundColor: '#3e70eb',
              padding: '7px 15px',
              color: 'white',
              border: 'none',
              borderRadius: '5px',
              cursor: 'pointer'
            }} onClick={toggle}>Exit</Button>{' '}
          </ModalFooter>
        </Modal>
      </div>
