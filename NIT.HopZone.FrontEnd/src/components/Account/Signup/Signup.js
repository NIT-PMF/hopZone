...
const SignupForm = () => {
  ...
  const [newUser, setNewUser] = useState({ role: 0, gender: "Male", city: "" });
          ...
          <div className="signup-container">
            <div className="App__Aside">
              ...
              <div className="App__Aside_Small">
                ...
                <br />
                You can add additional info about yourself later in the profile
                page :)
              </div>
            </div>
            <div className="App__Form">
              ...
              <div className="FormCenter">
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                    addUser({ variables: { user: newUser } });
                    setNewUser({});
                    console.log({ variables: { user: newUser } });
                  }}
              ...
              <ModalBody>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    NIT Company, Zmaja od Bosne 9.
                  </li>
                  <li>
                    <strong>Country</strong> refers to: Bosnia and Herzegovina
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Website</strong> refers to hopZone, accessible from
                    http://www.hopzone.com
                  </li>{" "}
                  <li>
